...
#%%
# this include merging two datasets into one
def preprocess():
...
# this include converting data types, dropping missing values, label encoding, and feature scaling
# and model training (XGBoost regression)
# and feature importance analysis (SHAP)
def main():
